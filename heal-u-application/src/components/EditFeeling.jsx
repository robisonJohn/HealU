    ...
    return (
        <form id="create-form" onSubmit={handleSubmit}>
            <div className="form-item">
                <label htmlFor="sentiment">How were you feeling generally?</label>
            </div>
            <div className="form-item">
                <input 
                type="text"
            ...
            <div className="form-item">
                <label htmlFor="emotionOne">What is the one major feeling you were experiencing on this day?</label>
            </div>
            <div className="form-item">
                <input 
                type="text"
            ...
            <div className="form-item">
                <label htmlFor="magnitudeOne">On a scale from 1-10, how strongly were you feeling this way?</label>
            </div>
            <div className="form-item">
                <input 
                type="range"
            ...
            <div className="form-item">
                <label htmlFor="emotionTwo">What is another major feeling you were experiencing on this day?</label>
            </div>
            <div className="form-item">
                <input 
                type="text"
            ...
            <div className="form-item">
                <label htmlFor="magnitudeTwo">On a scale from 1-10, how strongly were you feeling this way?</label>
            </div>
            <div className="form-item">
                <input 
                type="range"
            ...
            <div className="form-item">
                <label htmlFor="emotionThree">What is a third major feeling you were experiencing on this day?</label>
            </div>
            <div className="form-item">
                <input 
                type="text"
            ...
            <div className="form-item">
                <label htmlFor="magnitudeThree">On a scale from 1-10, how strongly were you feeling this way?</label>
            </div>
            <div className="form-item">
                <input 
                type="range"
            ...
            <div className="form-item">
                <label htmlFor="reason">Why do you think you were feeling this way?</label>
            </div>
            <div className="form-item">
                <textarea 
                id="reason"
