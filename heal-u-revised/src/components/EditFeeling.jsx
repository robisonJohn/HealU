            ...
            <Form onSubmit={handleSubmit} id="form">
                ...
                <Card className="form-card">
                    <Form.Group controlId="emotion" id="emotion">
                            <Row className="row">
                                <Form.Label className="label">How were you feeling?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={emotion}
                ...
                <Card className="form-card">
                    <Form.Group controlId="magnitude">
                        <Row className="row">
                            <Form.Label className="label">How strongly were you experiencing this emotion?</Form.Label>
                        </Row>
                        <Row className="row">
                            <Form.Control type="range" value={magnitude}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="comfort">
                            <Row className="row">
                                <Form.Label className="label">To what degree did you feel comfortable and well-nourished?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={comfort}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="safety">
                            <Row className="row">
                                <Form.Label className="label">To what degree did you feel safe in your pesonal and professional environments?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={safety}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="relationships">
                            <Row className="row">
                                <Form.Label className="label">To what degree did you feel valued, respected and fulfilled in your relationships?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={relationships}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="confidence">
                            <Row className="row">
                                <Form.Label className="label">To what degree did you feel confident and self-assured?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={confidence}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="actualization">
                            <Row className="row">
                                <Form.Label className="label">To what degree were you the best possible present version of yourself?</Form.Label>
                            </Row>
                            <Row className="row">
                                <Form.Control type="range" value={actualization}
                    ...
                    <Card className="form-card">
                        <Form.Group controlId="reason">
                            <Row className="row">
                                <Form.Label className="label">Why do you think you felt this way?</Form.Label>
                            </Row>
                            <Row className="row">
